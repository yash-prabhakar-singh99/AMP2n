...
@FeignClient(value = "DropCatchFeignB", url = "https://api.dropcatch.com")
public interface DropCatchFeignB {
...
*/
    ...
    @PostMapping("/v2/bids")
    ResponseEntity<ResponsePlaceBiddc> placeBiddc(@RequestHeader(value = "Authorization", required = true) String bearer, @RequestBody List<Biddc> bids, @RequestParam String searchTerm);
