...
@FeignClient(value = "NamecheapfeignBQ", url = "https://aftermarketapi.namecheap.com/client/api")
public interface NamecheapfeignBQ {
    ...
    ResponsePlaceBidNc placeBidnc(@RequestHeader(value = "Authorization", required = true,defaultValue = "Bearer ef7b03f63d8a94e2f083b991a74dd5852s5DuDtyOc9Ft1QZ5u0plxLpA0vlYdHFxEccAez6lh/wUyQNkOTCfqcOgrYMcvG4") String bearer, @PathVariable String id, @RequestBody Bidnc bid, @RequestParam String name);

    @GetMapping("/sales/{id}")
    AuctionDetailNC getAuctionDetailbyId(@RequestHeader(value = "Authorization", required = true,defaultValue = "Bearer ef7b03f63d8a94e2f083b991a74dd5852s5DuDtyOc9Ft1QZ5u0plxLpA0vlYdHFxEccAez6lh/wUyQNkOTCfqcOgrYMcvG4") String bearer, @PathVariable String id, @RequestParam String name);
