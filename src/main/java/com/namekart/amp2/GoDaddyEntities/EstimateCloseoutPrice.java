...
@XmlRootElement(name="EstimateCloseoutDomainPrice")
@XmlAccessorType(XmlAccessType.FIELD)
public class EstimateCloseoutPrice {
    ...
    @XmlAttribute(name="closeoutDomainPriceKey")
    private String closeoutDomainPriceKey;
    ...
    public void setCloseoutDomainPriceKey(String closeoutDomainPriceKey) {
